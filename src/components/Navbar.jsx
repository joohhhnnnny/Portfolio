...
export const Navbar = ({menuOpen, setMenuOpen}) => {
  ...
  return (
    <nav className="fixed top-0 w-full z-40 bg-[rgba(10, 10, 10, 0.8)] backdrop-blur-lg border-b border-purple-500 shadow-lg">
      <div className="max-w-5xl m-auto px-4">
        <div className="flex justify-between items-center h-16">
          <a href="#home" className="font-mono text-xl font-bold text-white relative z-30"> 
            Joohhhnnnn<span className="text-purple-500">_v</span> 
          </a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#home" className="text-gray-300 hover:text-purple-500 transition-colors">
              Home
            </a>
